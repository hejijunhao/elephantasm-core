...
async def create_link(
    ...
    Validates that both memory and event exist and belong to the same Spirit.

    Raises:
        404: Memory or Event not found
        400: Memory and Event belong to different Spirits, or duplicate link
    """
...
async def create_bulk_links(
    ...
    Raises:
        ...
        400: Events belong to different Spirit than Memory
    """
