...
async def create_identity(
    ...
    logger.info(f"[create_identity] anima_id={anima_id}")
    logger.info(f"[create_identity] data={data}")
    if data:
        logger.info(f"[create_identity] data.model_dump()={data.model_dump()}")
        logger.info(f"[create_identity] data.model_dump(by_alias=True)={data.model_dump(by_alias=True)}")
...
async def update_identity(
    ...
    import logging
    logger = logging.getLogger(__name__)
    logger.info(f"[update_identity] identity_id={identity_id}")
    logger.info(f"[update_identity] data={data}")
    logger.info(f"[update_identity] data.model_dump()={data.model_dump()}")
    logger.info(f"[update_identity] data.model_dump(by_alias=True)={data.model_dump(by_alias=True)}")
    logger.info(f"[update_identity] data.model_dump(exclude_unset=True)={data.model_dump(exclude_unset=True)}")
