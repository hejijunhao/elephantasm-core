...
class LogOperations:
    ...
    def get_stats(
        ...
        q = select(func.count()).select_from(Event).where(
            Event.anima_id == anima_id, Event.is_deleted.is_(False)
        )
        ...
        q = select(func.count()).select_from(Memory).where(
            Memory.anima_id == anima_id, Memory.is_deleted.is_(False)
        )
        ...
        q = select(func.count()).select_from(Knowledge).where(
            Knowledge.anima_id == anima_id, Knowledge.is_deleted.is_(False)
        )
    ...
    def _fetch_events(
        ...
        q = (
            select(Event)
            .where(Event.anima_id == anima_id, Event.is_deleted.is_(False))
    ...
    def _fetch_memories(
        ...
        q = (
            select(Memory)
            .where(Memory.anima_id == anima_id, Memory.is_deleted.is_(False))
    ...
    def _fetch_knowledge(
        ...
        q = (
            select(Knowledge)
            .where(Knowledge.anima_id == anima_id, Knowledge.is_deleted.is_(False))
