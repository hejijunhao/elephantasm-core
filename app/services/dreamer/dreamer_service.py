...
Usage:
    ...
    background_tasks.add_task(run_dream_background, anima_id, session_id)
...
def run_dream_background(anima_id: UUID, session_id: UUID) -> None:
    """
    ...
    with get_db_session() as db:
        try:
            ...
            try:
                DreamerOperations.fail_session(db, session_id, str(e))
                db.commit()
