...
class MemoryPackCompiler:
    ...
    def _persist_pack(
        ...
        MemoryPackOperations.delete_old_packs(
            self.session,
            config.anima_id,
            keep_count=self.DEFAULT_RETENTION_COUNT,
        )

    def _serialize_pack(self, pack: MemoryPack) -> Dict[str, Any]:
        """
        Serialize runtime MemoryPack to JSONB-compatible dict.
