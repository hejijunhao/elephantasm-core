...
class PendingEventResponse(BaseModel):
    """Pending event included in pack."""
...
class PackResponse(BaseModel):
    ...
    pending_event_count: int = Field(default=0, description="Number of pending events included")
    knowledge_count: int
    ...
    has_pending_events: bool = Field(
        default=False, description="Whether pending events were included"
    )
    ...
    pending_events: List[PendingEventResponse] = Field(default_factory=list)
