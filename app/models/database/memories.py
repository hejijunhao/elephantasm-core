...
class Memory(MemoryBase, TimestampMixin, table=True):
    ...
    # UMAP-projected 2D coordinates for semantic constellation visualization
    map_x: float | None = Field(default=None, nullable=True, description="UMAP X coordinate [0, 1]")
    map_y: float | None = Field(default=None, nullable=True, description="UMAP Y coordinate [0, 1]")
