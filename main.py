...
from app.services.scheduler import get_scheduler_orchestrator, get_memory_synthesis_scheduler, get_dreamer_scheduler, get_billing_scheduler
...
async def lifespan(app: FastAPI):
    ...
    if settings.ENABLE_BACKGROUND_JOBS:
        ...
        billing = get_billing_scheduler()
        await billing.register()
        logger.info("Billing scheduler registered (24h interval)")
